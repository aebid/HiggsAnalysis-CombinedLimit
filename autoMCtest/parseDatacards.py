...
def generatedatacard(rootdir, masspoints, prefix, addobservation, autoMC = False):
    #channels = ["MuMu","MuEl","ElEl"]
...
def parseDatacards_NNcut1D(inputdir, nnout, outdir_prefix):
	...
	generatedatacard(outdir, masslist, prefix_out, True, True)
...
def parseDatacards_NNcut2D(inputdir, nnout, outdir_prefix):
    ...
    #NNcutlist = [0.28, 0.36, 0.40, 0.48]
    NNcutlist = [0.56, 0.60,  0.72]
...
method = "Asymptotic"
masslist = [260, 270, 300, 350, 400, 450, 500, 550, 600, 650, 750, 800, 900]
parseDatacards_NNcut1D(inputdir, "nnout_MTonly", prefix_out)
...
inputdir = "2D/"
#parseDatacards_NNcut2D(inputdir, "nnout_MTonly", prefix_out)
...
#writeintoworkspace_1D([260], "Hhh_FinalBGYield_xsec1pb_NN_nnout_MTonly_nnstep0p04_nncut0p72", "DNN", 0.12, 2.76, "1D", "test", "")
#generatedatacard("", [260], "test", True)
