...
workdir = "/afs/cern.ch/user/d/daebi/public/diHiggs/CMSSW_8_1_0/src/HiggsAnalysis-CombinedLimit/autoMCtest/2D_HMEv4_1p15_dnn_0p1/"
indir = workdir+"HHbbWW_20200401_NNoutput_MjjCR_NNcutstudy2D_HMEbinsv4_1p15_NNout0p1/"
...
for var in varlist:
  for mass in masslist:
    f = ROOT.TFile.Open(indir+"Hhh_FinalBGYield_xsec1pb_NNvsHME_nnout_{var}_nnstep0p1_nncut0p0_SignalM{m}.root".format(m = mass, var = var))
