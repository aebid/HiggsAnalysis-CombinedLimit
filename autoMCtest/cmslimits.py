...
def makeLimitsPlots(masslist, workdir, plotsuffix=""):
	...
	for channel in channels:
	    ...
	    logfile = os.path.join(thisdir,  "GGToX0ToHHTo2B2L2Nu_M{mass}_{ch}_{suffix}.log".format(mass = mass, ch = channel, suffix =scriptsuffix))
            logfile = os.path.join(thisdir,  "GGToX0ToHHTo2B2L2Nu_M{mass}_{ch}.log".format(mass = mass, ch = channel))
...
def getlimits_nncut1D(masslist, nnout, outdir_prefix):
    ...
    pwd = "/afs/cern.ch/user/d/daebi/public/diHiggs/CMSSW_8_1_0/src/HiggsAnalysis/CombinedLimit/HH_WWbb/1D_combine/"
    pwd = "/afs/cern.ch/user/d/daebi/public/diHiggs/CMSSW_8_1_0/src/HiggsAnalysis/CombinedLimit/autoMCtest/"
...
def getlimits_nncut2D(masslist, nnout, outdir_prefix):
    ...
    #nnout = "nnout_MTonly"
    pwd = "/afs/cern.ch/work/t/tahuang/CombinedLimit/ForGithub/CMSSW_8_1_0/src/HiggsAnalysis/CombinedLimit/HH_WWbb/"
    pwd = "/afs/cern.ch/user/d/daebi/public/diHiggs/CMSSW_8_1_0/src/HiggsAnalysis/CombinedLimit/HH_WWbb/2D_combine/"
    condordir = pwd+"/condor/"
